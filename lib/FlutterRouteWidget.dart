...
//
//   //可选参数构造函数
//   FlutterRouteWidget({required this.params,required this.message});
//
//   @override
...
//         title: Text('Flutter Boost'), systemOverlayStyle: SystemUiOverlayStyle.dark,
//       ),
...
//   @override
//   Widget build(BuildContext context) {
//     return FlutterRouteWidget(message:"Flutter 有状态 Widget", params: {},);
//   }
//
//   @override
//   void dispose() {
